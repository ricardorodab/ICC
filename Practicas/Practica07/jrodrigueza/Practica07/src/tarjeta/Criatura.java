...
public class Criatura extends Tarjeta {
    private int ataque;
    private int defensa;
     ...
     * @param ataque - Es el ataque de la tarjeta.
     * @param defensa - Es la defensa de la tarjeta.
     * @param efecto - Es el efecto de la tarjeta.
     * @param leyenda - Es la leyenda de la tarjeta.
     * @param tipo - Es el tipo de la tarjeta.
     */
    public Criatura(String nombre, String edicion, String color, int numCarta, int costoGenerico, int costoColor, int ataque, int defensa, String efecto, String leyenda, String tipo){
